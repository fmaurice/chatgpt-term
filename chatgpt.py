...
parser.add_argument("-d", "--debug", action="store_true", help="debug mode : show only the request", )
parser.add_argument("-dr", "--debug-response", action="store_true", help="debug mode : show the complete response", )
